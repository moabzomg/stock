...
REQUIREMENTS:
  - TWS open, API enabled, port 7497 (PAPER account!)
...
# ── Config ────────────────────────────────────────────────────────────────────
PORT           = 7497        # PAPER trading port — NOT 7496 (live)!
HOST           = '127.0.0.1'
CLIENT_ID      = 5
...
def main():
    ...
    try:
        ...
        log("✅ Connected to TWS (PAPER account)")
    except Exception as e:
        log(f"❌ Connection failed: {e}")
        log("   Make sure TWS is on port 7497 (paper trading)")
        return
